...
const horoscopeData = {
    ...
    libra: {
        ...
        name: 'Весы',
        love: [
            "Баланс и гармония - ключ к успешным отношениям сегодня.",
            "Компромисс поможет решить любые разногласия."
        ],
        career: [
            "Сотрудничество принесет лучшие результаты, чем работа в одиночку.",
            "Ваше чувство справедливости поможет в принятии решений."
        ],
        money: [
            "Взвешенные финансовые решения принесут стабильность.",
            "Хороший день для планирования совместных покупок."
        ],
        health: [
            "Баланс между работой и отдыхом улучшит самочувствие.",
            "Йога или медитация помогут найти внутреннюю гармонию."
        ],
        mood: [
            "День гармонии и красоты. Окружите себя прекрасным.",
            "Ваш дипломатический подход помогает в общении."
        ]
    },
    scorpio: {
        icon: '♏',
        name: 'Скорпион',
        love: [
            "Глубокие эмоциональные связи укрепят ваши отношения.",
            "Доверие - основа успеха в личной жизни сегодня."
        ],
        career: [
            "Интуиция подскажет верное решение в сложных ситуациях.",
            "Ваша настойчивость поможет достичь цели."
        ],
        money: [
            "Стратегическое планирование finances принесет результаты.",
            "Возможны неожиданные источники дохода."
        ],
        health: [
            "Глубокий отдых и восстановление сил важны сегодня.",
            "Внимание к деталям поможет сохранить здоровье."
        ],
        mood: [
            "День трансформации и глубины. Прислушайтесь к интуиции.",
            "Ваша страсть и целеустремленность вдохновляют."
        ]
    },
    sagittarius: {
        icon: '♐',
        name: 'Стрелец',
        love: [
            "Приключения и новые впечатления укрепят отношения.",
            "Оптимизм и чувство юмора - ваши лучшие помощники."
        ],
        career: [
            "Расширение горизонтов принесет новые возможности.",
            "Международные связи могут быть особенно удачными."
        ],
        money: [
            "Инвестиции в образование и путешествия окупятся.",
            "Возможны неожиданные финансовые возможности."
        ],
        health: [
            "Активный отдых на природе улучшит самочувствие.",
            "Долгие прогулки принесут пользу и удовольствие."
        ],
        mood: [
            "День свободы и приключений. Исследуйте новое!",
            "Ваш оптимизм заразителен для окружающих."
        ]
    },
    capricorn: {
        icon: '♑',
        name: 'Козерог',
        love: [
            "Надежность и стабильность - основа отношений сегодня.",
            "Серьезный подход к чувствам будет оценен партнером."
        ],
        career: [
            "Дисциплина и трудолюбие приведут к успеху.",
            "Долгосрочное планирование особенно эффективно."
        ],
        money: [
            "Консервативный подход к финансам принесет стабильность.",
            "Хороший день для инвестиций в недвижимость."
        ],
        health: [
            "Регулярность и режим - ключ к хорошему самочувствию.",
            "Умеренные физические нагрузки принесут пользу."
        ],
        mood: [
            "День ответственности и достижений. Двигайтесь к цели!",
            "Ваша надежность вызывает уважение окружающих."
        ]
    },
    aquarius: {
        icon: '♒',
        name: 'Водолей',
        love: [
            "Дружба и интеллектуальная связь укрепят отношения.",
            "Нестандартный подход к романтике будет оценен."
        ],
        career: [
            "Инновационные идеи принесут успех в работе.",
            "Сотрудничество с единомышленниками особенно продуктивно."
        ],
        money: [
            "Инвестиции в технологии и innovation могут быть удачными.",
            "Хороший день для финансового планирования будущего."
        ],
        health: [
            "Техники релаксации и meditation помогут снять stress.",
            "Необычные виды fitness принесут удовольствие."
        ],
        mood: [
            "День инноваций и свободы. Мечтайте о будущем!",
            "Ваша оригинальность вдохновляет окружающих."
        ]
    },
    pisces: {
        icon: '♓',
        name: 'Рыбы',
        love: [
            "Романтика и духовная связь укрепят отношения.",
            "Эмпатия и понимание - ключ к гармонии сегодня."
        ],
        career: [
            "Творческий подход принесет успех в работе.",
            "Интуиция подскажет верное направление действий."
        ],
        money: [
            "Инвестиции в искусство и beauty могут быть удачными.",
            "Доверяйте интуиции в финансовых вопросах."
        ],
        health: [
            "Водные процедуры и отдых у воды улучшат самочувствие.",
            "Медитация и dream work особенно полезны сегодня."
        ],
        mood: [
            "День мечтаний и inspiration. Прислушайтесь к сердцу!",
...
// Запускаем когда вся страница загрузилась
window.addEventListener('load', function() {
    console.log('Страница полностью загружена');
    hideLoader();
});

// На всякий случай: скрыть loader через 3 секунды максимум
...
function showAdvice(sign, category) {
    ...
    if (resultIcon) resultIcon.textContent = signData.icon;
    if (resultTitle) resultTitle.textContent = `Совет для ${signData.name}`;
    if (adviceText) adviceText.textContent = randomAdvice;
...
function shareAdvice() {
    ...
    if (typeof VK !== 'undefined' && VK.Share) {
        ...
        navigator.clipboard.writeText(shareText).then(() => {
            ...
            alert('Совет скопирован в буфер обмена!');
        });
    }
}
